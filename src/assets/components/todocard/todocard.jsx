...
import style_update from './update.module.css'
...
function TodoCard(props){
   ...
   let mark = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="22" height="22" fill={props.complete ? "var(--dr-red)" : "var(--TextColor)"}><path d="M11.602 13.7599L13.014 15.1719L21.4795 6.7063L22.8938 8.12051L13.014 18.0003L6.65 11.6363L8.06421 10.2221L10.189 12.3469L11.6025 13.7594L11.602 13.7599ZM11.6037 10.9322L16.5563 5.97949L17.9666 7.38977L13.014 12.3424L11.6037 10.9322ZM8.77698 16.5873L7.36396 18.0003L1 11.6363L2.41421 10.2221L3.82723 11.6352L3.82604 11.6363L8.77698 16.5873Z"></path></svg>;
   let edit = <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="19" height="19" fill="var(--TextColor)"><path d="M12.8995 6.85453L17.1421 11.0972L7.24264 20.9967H3V16.754L12.8995 6.85453ZM14.3137 5.44032L16.435 3.319C16.8256 2.92848 17.4587 2.92848 17.8492 3.319L20.6777 6.14743C21.0682 6.53795 21.0682 7.17112 20.6777 7.56164L18.5563 9.68296L14.3137 5.44032Z"></path></svg>;
   ...
   const UpdateTask = ()=>{
      ...
      const saveUpdate = ()=>{ 
         props.updateThisTask(props.index, userTxt, userNewDate, realDate, word_length);
         setUserNewDate('');
         setRealDate('');
         setUserTxt('');
         setWord_length(0);
      ...
      return(
         <>
            <div className={style_update.input_container}>
               <div className={style_update.input_body}>
                  ...
                  <div className={style_update.date_con}>
                     <p className={style_update.date_title}>Card Date: </p>
                     <input value={realDate} onChange={changeDate} type="date" id='inp_update_date' className={style_update.user_date} />
                  </div>
      ...
      <>
         <div className={style.card}>
            <div className={style.card_header}>
               ...
               <p className={style.card_title}>{props.date}</p>
               <button onClick={()=>{ 
                  openConfDialog()
            ...
            <div className={style.card_footer}>
               <p className={style.ct_word_length}>Words {props.wordsLength}</p>
         ...
         {/* updDate={props.date} updWordLength={props.wordsLength}  */}
